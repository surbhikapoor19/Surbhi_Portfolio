...
<p>Designed and deployed an end-to-end fraud detection platform using LayoutLMv3, SentenceTransformers, XGBoost, and OpenAI API integrations. Built containerized FastAPI services, deployed on AWS, and owned architecture decisions and product demos.</p>
...
<p>Fine tuned transformer models for document processing and entity extraction across millions of invoice records. Built text classification and normalization pipelines and led EDA and BI reporting for finance, operations, and product stakeholders.</p>
